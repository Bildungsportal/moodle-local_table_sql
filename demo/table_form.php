...
$PAGE->set_url('/local/table_sql/demo/table_form.php', []);
$PAGE->set_heading("Demo for local_table_sql with forms");
$PAGE->set_title("Demo for local_table_sql with forms");
